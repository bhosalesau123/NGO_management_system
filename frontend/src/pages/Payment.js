...
// import netBankingLogo from '../assets/net-banking.png'; 
// import qrCodeImage from '../assets/fake-qr-code.png'; 
// import cardPaymentLogo from '../assets/card-payment.png'; 
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (typeof onNewTransaction === 'function') {
        ...
        console.error('onNewTransaction is not a function');
      }
      ...
      console.error('Error processing payment', error);
      const newTransaction = { id: Date.now(), amount, status: 'Success' };
      setTransactions([...transactions, newTransaction]);
